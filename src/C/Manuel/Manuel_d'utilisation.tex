...
Pour que le module puisse être installé correctement, le framework de test Check est nécessaire
...
\part[Exemples de configuration]{Exemples de configuration\footnote{Les exemples de configurations suivants ont été fait sur Archlinux.}}
\section{SSH}
