...
public class SntpClient {
    ...
    public boolean requestTime(String host, int timeout) {
        ...
        try {
            ...
            DatagramPacket request = 
            	new DatagramPacket(buffer, buffer.length, address, NTP_PORT);
            ...
            long roundTripTime = 
            	responseTicks - requestTicks - (transmitTime - receiveTime);
            // receiveTime = originateTime + transit + skew
            // responseTime = transmitTime + transit - skew
            // clockOffset 
            //	= ((receiveTime - originateTime) 
    ...
    /**
     * Returns the reference clock value 
