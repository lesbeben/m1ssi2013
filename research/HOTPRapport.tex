...
\section{Analyse générale et sécurité}
  ...
  \end{itemize}
    ...
    Le protocole HOTP ne possède aucunes failles connues mis à part les failles héritées de OTP.
    ...
    Il est conseillé de choisir une longueur d'OTP entre 6 et 8 charactères afin que le mot de passe soit à la fois facilement utilisable et sécurisé.
