...
\begin{document}
  ...
  La réalisation des tests ainsi que leur execution seront réalisés par le responsable qualité et son assistant. Les données de test pourront être fournies par ces 
  même personnes.
  ...
  Les tests seront toujours tous appliqués sur les éléments sur lesquels il sont applicables sauf dans les cas ou un résultat négatif empêcherait de poursuivre les 
  procédures.
  
  Les tests pmourront généralement être exécutés indépendement sur le token et le vérifieur. Les dépendances entre tests seront précisées dans la suite de ce document.
  ...
  \begin{itemize}
   ...
   qualité contrariée.
   \item Diffusion de la note à l'équipe de développement. Cette dèrnière devra établir une contre-note portant le même identifiant et précisant les raisons supposées 
  ...
  \begin{center}
    ...
    \begin{tabular}{|c|p{5cm}|p{5cm}|p{1.5cm}|p{1.5cm}|}
      ...
      \hline
      \multicolumn{5}{|l|}{Rèpéter 4 et 5 jusqu'à la fin de l'éxécution.}\\
      \hline
