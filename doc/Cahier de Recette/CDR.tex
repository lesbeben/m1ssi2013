...
\begin{document}
  ...
  \begin{center}
    ...
    \begin{tabular}{|c|p{5cm}|p{5cm}|p{1.5cm}|p{1.5cm}|}
      ...
      \hline
      \multicolumn{5}{|l|}{Répéter 1 et 2 jusqu'à la connection ou le rejet}\\
      \hline
  ...
  \begin{center}
    \begin{tabular}{|p{3cm}|p{4cm}|p{3cm}|p{5cm}|}
      ...
      & Le test de cette exigence dépend de la'implémentation de la méthode d'OTP. Elle sera détaillée dans une prochaine version.\\ \hline
      ...
      & Ce test, nécessitant l'utilisation d'un \fg{}die hard\og{}, requière une étude préalable et ne peut \^etre détaillé.\\ \hline
