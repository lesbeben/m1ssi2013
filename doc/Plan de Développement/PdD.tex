...
\begin{description}
	...
	\begin{description}
		...
		\item[Prévisions :] Du 29/03/14 au 19/04/14 - Vérification d'OTP disponible + Interface du token.
		\item[Objet des vérifications :] Compilation du code + Tests.
	...
	\begin{description}
		...
		\item[Prévisions :] Du 05/04/14 au 19/04/14 - Vérification d'OTP disponible + Interface du token.
		\item[Objet des vérifications :] Tests.
	...
	\begin{description}
		...
		\item[Prévisions :] Du 19/04/14 au 03/05/14 - Authentification + utilitaire en ligne de commande disponible.
		\item[Objet des vérifications :] Compilation du code + Tests.
	...
	\begin{description}
		...
		\item[Prévisions :] Du 03/05/14 au 11/05/14 - Authentifications possibles.
