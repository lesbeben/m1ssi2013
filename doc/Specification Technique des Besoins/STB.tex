...
Etude et impl\'{e}mentations des systèmes d'authentification utilisant des mots de passe jetables :
    ...
    \subsection{Besoins op\'{e}rationnels} 
        \begin{itemize}
    ...
    \subsection{Contraintes et recommandations} 
        ...
        \end{itemize}
    \subsection{R\'{e}sultats attendus} 
        \begin{itemize}
