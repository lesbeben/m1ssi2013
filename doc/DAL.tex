...
\begin{tabular}{|p{0.15\textwidth}|p{0.7\textwidth}|p{0.15\textwidth}|}
    \hline
    \rowcolor{gray}
...
\subsection{Générateur d'OTP}
    Chaque algorithme \'etudi\'e et impl\'emet\'e (HOTP, OTPW, POTP) offrira les
    ...
    \begin{description}
        ...
        \item[geHOTP(user * utilisateur)] Génère un OTP selon la méthode et les
            paramêtres passés.
    \end{description}
...
\subsubsection{Le langage Java}
    ...
    sur android, ce n'est pas recommand\'e.
