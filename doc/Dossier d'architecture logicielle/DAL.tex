...
\begin{description}
    ...
    \item[Seed] Variable utilis\'e pour initiliser une s\'equence al\'eatoire.
\end{description}
...
\begin{tabular}{|p{0.2\textwidth}|p{0.4\textwidth}|p{0.4\textwidth}|}
    ...
    Étant donn\'e que le calcul de l'OTP ne prends que très peu de ressources
            et que les plateformes sont diverse le critère des \verb?700MHz? de puissances
...
\begin{tabular}{|p{0.2\textwidth}|p{0.4\textwidth}|p{0.4\textwidth}|}
    ...
    la seule choses qui justifie l'emploi de ce système d'exploitation
...
\begin{tabular}{|p{0.2\textwidth}|p{0.4\textwidth}|p{0.4\textwidth}|}
    ...
    \hline
    PR-L\_002 &
    Base de donn\'ee pour stocker les informations relatives aux utilisateur dans le serveur&
...
\subsection{Token}
    \subsubsection{Rôle}
        Afficher les mots de passes jetables pour un utilisateur donné.
