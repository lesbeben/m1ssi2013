...
\subsubsection{Risque 5 :}
	\begin{tabular}{| p{5cm} | p{2.5cm} | p{6.5cm} |}
		...
		\cellcolor{lightgray} Plan de réduction de risque 		& \multicolumn{2}{p{9cm}|}{Étude poussée de la-dite technologie sur les fonctionnalités utiles aux projet par le responsable technique.} \\ \hline
		...
		\cellcolor{lightgray}									& Action : 			& Étude de l'impasse avec le responsable technique puis recherche de solutions en consultant les doc (RFC, doc, tuto, forum...). Si l'impasse s'avère insolvable, recherche d'une alternative.\\ \hline
