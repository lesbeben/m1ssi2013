...
\histentry{1.4}{07/04/2014}{Prise en compte des changements de fin d'itération.}
\histentry{1.3}{21/02/2014}{Version post état de l'art.}
...
\begin{tabular}{| p{8.7cm} | p{0.8cm} | p{4.5cm} |}
	...
	\multirow{1}{*}{Emploi de techno. spécifiques (Android, PAM)}
		& R\_12 & Mauvaise appréhension des nouvelles technologies \\ \hline
	\multirow{2}{*}{Communication au sein de l'équipe}
		& R\_13 & Un ou plusieurs membre de l'équipe incompétent \\ \cline{2-3}
...
\subsubsection{Risque 5 :}
	\begin{tabular}{| p{5cm} | p{2.5cm} | p{6.5cm} |}
		\hline
		\multicolumn{3}{| p{14,5cm} |}{\cellcolor{gray}Identifiant : R\_12} \\ \hline
		\cellcolor{lightgray} Évènement/situation redouté(e) 	& \multicolumn{2}{p{9cm}|}{Mauvaise appréhension des nouvelles technologies.} \\ \hline
		\cellcolor{lightgray} Point dur associé 				& \multicolumn{2}{p{9cm}|}{Emploi de technologies spécifiques (Android, PAM).} \\ \hline
		...
		\cellcolor{lightgray} Critique 							& \multicolumn{2}{p{9cm}|}{\cellcolor{green} Non}\\ \hline
		\cellcolor{lightgray} Plan de réduction de risque 		& \multicolumn{2}{p{9cm}|}{Étude poussée de la-dite technologie sur les fonctionnalités utiles au projet par le responsable technique.} \\ \hline
		\cellcolor{lightgray} Plan d'action 						& Acteur : 			& Responsable technique \\ \cline{2-3}
		\cellcolor{lightgray}									& Déclenchement : 	& Impasse sur une fonctionnalité à implémenter.\\ \cline{2-3}
		\cellcolor{lightgray}									& But : 			& Résoudre l'impasse. \\ \cline{2-3}
		\cellcolor{lightgray}									& Action : 			& Étude de l'impasse avec le responsable technique puis recherche de solutions en consultant les documents (RFC, documentation, tutoriels, forums...). Si le problème s'avère insolvable, recherche d'une alternative.\\ \hline
		\cellcolor{lightgray} Statut/Date/Responsable 			& \multicolumn{2}{p{9cm}|}{Créé le 07/04/14 par Adrien \bsc{Smondack}.} \\ \hline
	\end{tabular}
...
\subsubsection{Risque 4 :}
	\begin{tabular}{| p{5cm} | p{2.5cm} | p{6.5cm} |} 
		...
		\cellcolor{lightgray}									& But : 			& Rétablir la compréhension technique \\ \cline{2-3}
...
\begin{tabular}{| p{5cm} | p{2.5cm} | p{6.5cm} |} 
		\hline
		\multicolumn{3}{| p{14,5cm} |}{\cellcolor{gray}Identifiant : R\_13} \\ \hline
		\cellcolor{lightgray} Évènement/situation redouté(e) 	& \multicolumn{2}{p{9cm}|}{Un ou plusieurs membre de l'équipe incompétent.} \\ \hline
		...
		\cellcolor{lightgray} Critique 							& \multicolumn{2}{p{9cm}|}{\cellcolor{red} Oui}\\ \hline
		\cellcolor{lightgray} Plan de réduction de risque 		& \multicolumn{2}{p{9cm}|}{Mise au point régulière sur l'avancement et les difficultées de chacuns.} \\ \hline
		\cellcolor{lightgray} Plan d'action 						& Acteur : 			& Chef de projet \\ \cline{2-3}
		\cellcolor{lightgray}									& Déclenchement :	& Demande de la part du-dit membres. \\ \cline{2-3}
		\cellcolor{lightgray}									& But : 			& Combler les lacunes. \\ \cline{2-3}
		\cellcolor{lightgray}									& Action : 			& Phase de dialogue puis accompagnement plus poussé. \\ \hline
		\cellcolor{lightgray}Statut/Date/Responsable 			& \multicolumn{2}{p{9cm} |} {Créé le 07/04/14 par Adrien \bsc{Smondack}.} \\ \hline
	\end{tabular}
...
\subsection{Plan d'action associés aux risques passés}
	\begin{tabular}{| p{5cm} | p{2.5cm} | p{6.5cm} |}
		\hline
		...
		\cellcolor{lightgray}Point dur associé 					& \multicolumn{2}{p{9cm}|}{Emploi de technologies spécifiques (Android, PAM).} \\ \hline
		\cellcolor{lightgray} Impact 							& \multicolumn{2}{p{9cm}|}{Préoccupant.} \\ \hline
		\cellcolor{lightgray} Probabilité 						& \multicolumn{2}{p{9cm}|}{Nulle.} \\ \hline
		\cellcolor{lightgray} Critique 							& \multicolumn{2}{p{9cm}|}{\cellcolor{green} Non}\\ \hline
	...
	\begin{tabular}{| p{5cm} | p{2.5cm} | p{6.5cm} |}
		...
		\cellcolor{lightgray}Impact 							& \multicolumn{2}{p{9cm}|}{Important.} \\ \hline
		\cellcolor{lightgray}Probabilité 						& \multicolumn{2}{p{9cm}|}{Faible.} \\ \hline
		\cellcolor{lightgray}Critique 							& \multicolumn{2}{p{9cm}|}{\cellcolor{green} Non}\\ \hline
		\cellcolor{lightgray}Plan de réduction de risque 		& \multicolumn{2}{p{9cm}|}{Suivi régulier des équipes par le responsable technique et le chef de projet.} \\ \hline
		\cellcolor{lightgray}Plan d'action 						& Acteur : 			& Chef de projet \\ \cline{2-3}
